    ...
    render() {
        return (
            <div className="Weather" > 
                ...
                <h2>
                    {this.props.lon && this.props.lat && <p> longitude , latitude: {this.props.lon} , {this.props.lat}</p>}
                </h2>
                <h3>
                ...
                <h5>
                    {this.props.humidity && this.props.description && <p> Humidity : {this.props.humidity}, {this.props.description} </p>}
                </h5>
